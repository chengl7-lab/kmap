...
# step 0: preprocess input fast file with background fast file
kmap preproc --fasta_file ./tests/test.fa --background_fasta_file ./tests/random_windows.fa --res_dir ./test
